...
public class SimPathsCollector extends AbstractSimulationCollectorManager implements EventListener {
    ...
    @GUIparameter(description="Calculate wealth characteristics (useful for validation)")
...
//		System.out.println("Median EDI " + median + " Poverty threshold " + atRiskOfPovertyThreshold);
    ...
    public void setStats3(Statistics3 stats3) { this.stats3 = stats3; }
    ...
    public boolean isPersistStatistics3() { return persistStatistics3; }
